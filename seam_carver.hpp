...
public:
  ...
  int** CreateEnergyArr() const;

  int** VertCarvingEnergies() const;

  int** HorizCarvingEnergies() const;

  int* FindVSeam(int** values) const;

  int* FindHSeam(int** values) const;
  ...
  int MinVal(int a, int b, int c) const;
  int MinVal(int a, int b) const;

  // int NextTrace(int col);
